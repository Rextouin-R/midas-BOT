...
class MidasBot:
    ...
    def banner(self):
        ...
        print(Fore.YELLOW + '[#] FOLLOW ' + Fore.GREEN + ' https://github.com/Rextouin-R/ ' + Fore.RESET)
        print(Fore.YELLOW + '[#] JOIN ' + Fore.GREEN + ' @airdrop_unlimited ' + Fore.RESET)
        print(Fore.YELLOW + '[#] JOIN ' + Fore.GREEN + ' @unlimited_discussion ' + Fore.RESET)
        print('')
