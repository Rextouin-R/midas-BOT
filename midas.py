...
class MidasBot:
    ...
    def banner(self):
        ...
        print(Fore.Cyan + '[#] FOLLOW    ' + Fore.GREEN + ' https://github.com/Rextouin-R/ ' + Fore.RESET)
        print(Fore.cyan + '[#] Welcome & enjoy ! MAKSIMALKAN', Fore.RESET)
        print(Fore.cyan + '[#] MODULS by mrplanktn ', Fore.RESET)
        print('')
