...
class MidasBot:
    ...
    def banner(self):
        ...
        print(Fore.BLUE + '[#] FOLLOW    ' + Fore.GREEN + ' https://github.com/Rextouin-R/ ' + Fore.RESET)
        print(Fore.BLUE + '[#] Welcome & enjoy ' + Fore.GREEN + ' MAKSIMALKAN ', + Fore.RESET)
        print(Fore.BLUE + '[#] MODULS by mrplanktn ', Fore.RESET)
        print('')
